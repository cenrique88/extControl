...
function App() {
  ...
  const openModalAddExt = () => {setIsOpenModalAddExt(true)};
  const closeModalAddExt = () => {setIsOpenModalAddExt(false)};

  const [isOpenModalShowExt, setIsOpenModalShowExt] = useState(false);
  const openModalShowExt = () => {setIsOpenModalShowExt(true)};
  const closeModalShowExt = () => {setIsOpenModalShowExt(false)};

  const [isOpenModalScanner, setIsOpenModalScanner] = useState(false);
  const openModalScanner = () => {setIsOpenModalScanner(true)};
  const closeModalScanner = () => {setIsOpenModalScanner(false)};
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpenModalAddExt} onClose={closeModalAddExt} content={<AddExtintor /> }/>
      <ModalShowExtList isOpen={isOpenModalShowExt} onClose={closeModalShowExt} content={<MostrarExtintores /> }/>
      <Modal isOpen={isOpenModalScanner} onClose={closeModalScanner} content={
      <Html5QrcodePlugin 
        fps={10}
        qrbox={300}
        disableFlip={false}
