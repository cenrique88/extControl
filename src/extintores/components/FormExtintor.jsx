...
const FormExtintor = ({ getDB, saveExtintor }) => {
    ...
    const data_ext = {
        ...
        tiempo: tiempo_manual.inputValue
        ? `${tiempo_manual.inputValue} Años`
        : `${tiempo.inputValue} Años`,
    ...
    <select onChange={(e) => setSelectedOption(e.target.value)} value={selectedOption}>
        {clientes.map((client) => (
        <option key={client._id} value={client.nombre_cliente}>
            {client.nombre_cliente}
        </option>
        ))}
    </select>

    <input type="text" placeholder="Ubicación" value={ubicacion.inputValue} onChange={ubicacion.handleChangeInput} />
    ...
    <input type="text" placeholder="Otro tipo..." value={tipo_manual.inputValue} onChange={tipo_manual.handleChangeInput} />
    ...
    <input type="text" placeholder="Otra capacidad..." value={capacidad_manual.inputValue} onChange={capacidad_manual.handleChangeInput} />
    ...
    <input type="number" placeholder="Otro tiempo..." value={tiempo_manual.inputValue} onChange={tiempo_manual.handleChangeInput} />
    ...
    <select value={estado_extintor.inputValue} onChange={estado_extintor.handleChangeInput}>
        <option value="">Estado Extintor</option>
    ...
    <input type="text" placeholder="Otro soporte..." value={soporte_manual.inputValue} onChange={soporte_manual.handleChangeInput} />

    <input type="date" value={fecha_inspeccion.inputValue} onChange={fecha_inspeccion.handleChangeInput} />
